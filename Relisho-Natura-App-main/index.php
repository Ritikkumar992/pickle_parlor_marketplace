...
<head>
    ...
    <title>RelishoNatura | Home page</title>
    ...
    <script type="text/javascript">
        ...
        })(window, document, "clarity", "script", "kz3jwrukca");
    </script>
...
<body>
    ...
    <!-- <section class="home-category">
        ...
        <div class="box-container">
            ...
            <div id="box" class="box">
                ...
                <h3>Spicy Mango</h3>
                <p>Try our mango pickle! It's made with ripe mangoes, traditional spices, and lots of care for a delicious flavor you'll love.</p>
                <a href="category.php?category=pickles" class="btn">Mango Pickle</a>
            </div>

            <div id="box" class="box">
                <img src="images/cat-6.png" alt="">
                <h3>Adrak Ginger</h3>
                <p> 100% Handmade in a very hygienic conditions, Natura Ginger Pickle is traditionally made with finest grade of spices. </p>
                <a href="category.php?category=Pickles" class="btn">Ginger Pickles</a>
            </div>
    ...
    <div class="Recommended-exam">
        ...
        <div class="heading">
            <h1 class="title">shop by category</h1>
            <h2>
                <a href="category.php?category=Pickles" style="color: orange; cursor: pointer; font-size: 20px">See
                    All</a>
            </h2>
        ...
        <div class="exams-list">
            <div class="box box1">
                <div class="box-top">
                    <img src="uploaded_img/image.png">
                    <div class=" text">
                        <h1>SPICY MANGO</h1>
                        <h3>Aachar & Co Homemade Aam Ka Achar ( SUKHA Hing WALA) - 500 gm</h3>
                    </div>
                ...
                <div class="box-bottom">
                    <p>Try our mango pickle! It's made with ripe mangoes, traditional spices, and lots of care for a
                        delicious flavor you'll love.</p>
                </div><a href=" category.php?category=pickles" class="btn" id="cat-btn">Mango Pickle</a>
            </div>
            <div class="box box1">
                <div class="box-top">
                    <img src="uploaded_img/image.png">
